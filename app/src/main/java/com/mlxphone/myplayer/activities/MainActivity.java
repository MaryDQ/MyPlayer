...
import com.mlxphone.myplayer.fragment.MyMuscicListFragment;
import com.mlxphone.myplayer.fragment.NetMusicListFragment;
...
public class MainActivity extends BaseActivity {
    ...
    private MyMuscicListFragment myMuscicListFragment;
...
//    private MyFavoriteFragment myFavoriteFragment;
    ...
    public void change(int position) {
        ...
        if (pager.getCurrentItem()==0){
            myMuscicListFragment.changeUIStatusOnPlay(position);
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position==0){
				if (myMuscicListFragment==null){
					myMuscicListFragment=MyMuscicListFragment.newInstance();
				}
				return myMuscicListFragment;
			}else if(position==1){
                ...
                if (myFavoriteFragment==null){
                    myFavoriteFragment=MyFavoriteFragment.newInstance();
                }
